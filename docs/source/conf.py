...
# car_price_predictions documentation build
...
from car_price_predictions import __version__ as release

# -- Project information -----------------------------------------------------

project = "car_price_predictions"
author = "Kedro"
...
htmlhelp_basename = "car_price_predictionsdoc"
...
latex_documents = [
    (
        master_doc,
        "car_price_predictions.tex",
        "car_price_predictions Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "car_price_predictions",
        "Project car_price_predictions codebase.",
        "Data-Science",
    )
]
